...
real feeds include deletes, replaces, sequence recovery, venue state changes, and symbol-level halt behavior. A serious reviewer should see that this risk is named directly rather than hidden behind
