...
themes are: best bid/ask updates, empty-side behavior, zero-size handling, and replayable state transitions. These checks are deliberately modest, but they establish a baseline that
